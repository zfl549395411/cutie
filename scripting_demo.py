...
def main():
    ...
    for ti, image_name in enumerate(images[50:]):
        ...
        image, mask = resize(image, mask, size=480)
        if ti == 0:
...
save_path = "/media/sti/B20F0FD71CF7DE70/FeishuDwonload/test_cutie/vedio_with_mask/test_subway_fa_480_752_nr_nusl_max4f_res18_sem_s100" 
